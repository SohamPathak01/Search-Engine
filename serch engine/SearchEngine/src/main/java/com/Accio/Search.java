    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            while (resultSet.next()) {
                SearchResult serchResult = new SearchResult();
                serchResult.setLink(resultSet.getString("pageLink"));
                serchResult.setTitle(resultSet.getString("pageTitle"));

                results.add(serchResult);
            }
